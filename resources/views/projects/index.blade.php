<x-app-layout title="Project">
    <div class="mb-5 flex items-start justify-between gap-3">
        ...
        <div class="flex shrink-0 items-center gap-2">
            <a href="{{ route('prices.index') }}" class="btn btn-secondary">
                <svg class="size-4 text-stone-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
    ...
    @forelse ($projects as $project)
        <a href="{{ route('projects.show', $project) }}"
           class="card mb-2 block px-4 py-3.5 transition-colors hover:border-stone-300 hover:bg-stone-50/60">
            <div class="flex items-start justify-between gap-3">
                <div class="min-w-0">
                    <h2 class="truncate font-medium text-stone-900">{{ $project->name }}</h2>
