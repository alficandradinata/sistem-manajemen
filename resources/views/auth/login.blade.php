    ...
    <div class="flex min-h-full items-center justify-center px-4 py-12">
        <div class="w-full max-w-sm">
            <div class="mb-9 text-center">
                <svg class="mx-auto mb-5 h-10 w-10 text-stone-900" viewBox="0 0 40 40" fill="none"
                     stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M4 19 20 6l16 13"/>
                    <path d="M9 23v11h22V23"/>
                </svg>
                <h1 class="text-sm font-medium tracking-[0.25em] text-stone-900 uppercase">Datalaila</h1>
                <div class="mx-auto my-3.5 h-px w-8 bg-stone-200"></div>
                <p class="text-xs tracking-wide text-stone-400">Manajemen file &amp; harga project</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="card-pad">
                ...
                <label class="mb-5 flex items-center gap-2 text-sm text-stone-600">
